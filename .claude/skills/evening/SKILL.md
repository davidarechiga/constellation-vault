...
```
find "/Users/davidarechiga/Constellation/Constellation" -name "*.md" -newer "/Users/davidarechiga/Constellation/Constellation/C - Signal Relay/Daily/$(date -v-2d +%Y-%m-%d).md" -not -path "*/C - Signal Relay/*" -not -path "*/.obsidian/*" -not -path "*/Templates/*" -not -path "*/TaskNotes/*" -not -path "*/Archive/*"
```
