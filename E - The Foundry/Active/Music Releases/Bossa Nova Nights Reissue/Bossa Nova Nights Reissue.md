...
# 🌙 Bossa Nova Nights Reissue

> **BPM:** &nbsp;&nbsp;&nbsp; **Key:** &nbsp;&nbsp;&nbsp; **Genre/Vibe:** Bossa Nova &nbsp;&nbsp;&nbsp; **References:**

**Type:** Reissue — full mix & master | **Target:** TBD | **Distribution:** LANDR

> Original recordings exist but need a full new mix and master before reissue. Not a simple artwork swap — this is a proper production pass.

---

## Vision & Direction

*What should the new mix feel like compared to the original? Sonic direction, references:*
...
- [ ] Locate and organize all original session files
- [ ] Rename all tracks
...
- [ ] Set tempo and drop section markers
...
### Audio
- [x] Original recordings exist
- [ ] Sessions located and reopened
- [ ] Full mix complete
- [ ] Mastering complete
- [ ] New metadata and credits prepared

### Visual
- [ ] New artwork concept finalized
...
*What needs to change from the original mix? Any tracks that need extra attention:*
...
| Date | Notes |
|------|-------|
| 2026-03-22 | Split off as standalone release — needs full mix & master |
