...
> **BPM:** &nbsp;&nbsp;&nbsp; **Key:** &nbsp;&nbsp;&nbsp; **Genre/Vibe:** Emotional, intimate &nbsp;&nbsp;&nbsp; **References:**

**Type:** EP (4-5 songs) | **Target:** April 2026 | **Distribution:** LANDR

> Low-pressure re-entry into releasing after 9 years. Keep scope manageable — build confidence post-baby, not a magnum opus.

---

## Vision & Direction

- Emotional, intimate aesthetic
- Limited color palette
- Hand-drawn or collage elements

See [[Album Visual Concepts]] for full visual direction.
...
### Audio
- [ ] Final track listing confirmed (4-5 songs)
- [ ] Demo recordings complete
- [ ] Mixing done
- [ ] Mastering done
...
- [ ] Social media assets (IG, YouTube, Bandcamp, Spotify banners)

### Distribution
- [ ] Submit to LANDR by **March 15**
- [ ] Verify on Spotify, Apple Music, Bandcamp, YouTube

### Marketing
- [ ] Teaser content created (30s–1min)
...
*Vibe, references, what you want the EP to feel like, what you're unsure about:*
...
| Date | Notes |
|------|-------|
| 2026-03-22 | Project folder created |
