...
**Purpose:** Compare costs and coverage for adding Cyrus to healthcare plans
**Date Created:** 2026-01-07
**Status:** 🔄 In Progress
**Decision Deadline:** [Add your open enrollment deadline]

---

## Quick Decision Summary

**Preferred Option:** [ ] My Plan  [ ] Wife's Plan
**Reason:**
...
**Plan Name/Provider:** Cigna Health
**Plan Type:** [ ] HMO  [✔️] PPO  [ ] EPO  [ ] HDHP

#### Monthly Premiums
- Current (Employee + Spouse): $
- With Cyrus (Employee + Spouse + 1 Child): $
...
- Pediatric Vision/Dental Included: [ ] Yes  [ ] No

---

### Wife's Healthcare Plan
...
| Feature | My Plan | Wife's Plan | Winner |
|---------|---------|-------------|--------|
...
| Pediatrician in network | [ ] Yes  [ ] No | [ ] Yes  [ ] No | |
| Employer HSA contribution | $ | $ | |
...
### Provider Network
- **Preferred pediatrician in network?**
  - My Plan: [ ] Yes  [ ] No - Dr. [Name]
  - Wife's Plan: [ ] Yes  [ ] No - Dr. [Name]

- **Preferred hospital in network?**
  - My Plan: [ ] Yes  [ ] No - [Hospital Name]
  - Wife's Plan: [ ] Yes  [ ] No - [Hospital Name]

### Pediatric-Specific Coverage
- **Well-child visits covered?**
  - My Plan: [ ] Yes  [ ] No
  - Wife's Plan: [ ] Yes  [ ] No
...
### Scenario: Low Healthcare Usage
(Only preventive care, well-child visits)

- **My Plan Total:** Premium ($ × 12) = $
- **Wife's Plan Total:** Premium ($ × 12) = $

### Scenario: Moderate Healthcare Usage
(Preventive care + 3 sick visits + 2 prescriptions)

- **My Plan Total:** $
- **Wife's Plan Total:** $

### Scenario: High Healthcare Usage
(Hit family deductible)
...
- Open enrollment timing differences
...
**Tags:** #healthcare #family #decision #finance
